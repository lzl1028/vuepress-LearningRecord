...
### 一. 2XX(Success 成功状态码):
- 2XX 响应的结果标明请求被正常处理了
- 200 OK:表示从客户端发来的请求在服务器端被正常处理了![image](https://user-gold-cdn.xitu.io/2017/12/6/16029efa6af2ea6c?imageView2/0/w/1280/h/960/ignore-error/1)
...
- 301 Moved Permanently：永久性重定向![image](https://user-gold-cdn.xitu.io/2017/12/6/16029efa6a4ba749?imageView2/0/w/1280/h/960/ignore-error/1)
    - 该状态码表示请求的资源已被分配了新的 URI，以后应使用资源现在所指的 URI。也就是说，如果已经把资源对应的 URI 保存为书签了，这时应该按 Location 首部字段提示的 URI 重新保存
- 302 Found：临时性重定向![image](https://user-gold-cdn.xitu.io/2017/12/6/16029efba78b2b7e?imageView2/0/w/1280/h/960/ignore-error/1)
